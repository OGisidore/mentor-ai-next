    ...
    const languageMessage = {
      ...
      item: {
        ...
        content: [
          {
            type: "input_text",
            text: "Speak and respond only in  French. It is crucial that you maintain your responses in french. If the user speaks in other languages, you should still respond in English."
          },
        ],
      },
    };
